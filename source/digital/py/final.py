...
while True:
    ...
    if pin7.read_digital() and i<1200:
        f.clear()
        i+=100
        ...
        sleep(700) 
    # set 1(+n):30
    if pin13.read_digital() and i>100:
        f.clear()
        i -= 100
        if i > 1259 or i < 100 or (i%100)>59:
            i+=100
        ...
        f.update_display()
        sleep(700)
    if pin6.read_digital() and i<1000:
        f.clear()
        i += 1000
        if i > 1259 or i < 100 or (i%100)>59:
            i-=1000
        ...
        f.update_display()
        sleep(700)
    if pin12.read_digital() and i>1000:
        f.clear()
        i -= 1000
        if i > 1259 or i < 100 or (i%100)>59:
            i+=1000
        ...
        f.update_display()
        sleep(700)
    if pin8.read_digital() and (i%100)<50:
        f.clear()
        i += 10
        if i > 1259 or i < 100 or (i%100)>59:
            i-=10
        ...
        f.update_display()
        sleep(700)
    if pin14.read_digital() and (i%100)>0:
        f.clear()
        i -= 10
        if i > 1259 or i < 100 or (i%100)>59:
            i+=10
